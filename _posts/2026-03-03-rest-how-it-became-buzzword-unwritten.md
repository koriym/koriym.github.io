...
- 誤用のままでいることが、その先の判断も歪めている。「RESTを試してダメだったから次へ行こう」と言っている人は、RESTを試していない。誤った地図で歩いた人が「この地図の先は崖だ」と報告している。地図が違う
...
- 25年間の集合的エンジニアリング努力が、人工的な問題（バージョニング、ステータスコード論争、OpenAPI保守）の解決に費やされた。もし業界がハイパーメディアを本当に理解して適用していたら、Webはどうなっていたか。それは永遠にわからない
