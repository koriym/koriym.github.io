...
A1. 「イベントドリブンコンテンツ」という言葉は知りませんでしたが、「破壊的変更が行われるまで消去されない[リソースキャッシュ](https://koriym.github.io/2010/05/resource_cache/)」のアイデアは[BEAR.Sundayの設計時からありました](https://gist.github.com/koriym/1111850/286a832895512ec268c5b997a19e7077628923c0)。
しかし当時はどうすれば実現の足掛かりができるのかすら分かりませんでしたし、実現するにしてもサーバーサイドのキャッシュで行うつもりでした。
またCQRSの提唱者のGregさんの[CQRS meets REST](https://twitter.com/gregyoung/status/14040334079)の考えにも影響を受けていました。
...
時に「Qiitaに載ってない」と文句を言われることがあるかもしれません。しかし、そんな人が大勢ユーザーになってくれても、プロジェクトを前に進める力にはなりません。
