...
- During the HTTP/1.1 design process, Fielding rejected the proposed MGET method—batch retrieval of multiple resources—on the grounds that it would compromise proxyability and cacheability. The "why" behind this decision was never transmitted. The inability to fetch multiple resources at once came to look like "a limitation of REST." GraphQL "solved" it—sacrificing proxyability and cacheability in the process
